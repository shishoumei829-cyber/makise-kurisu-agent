...
> **方向更新：** Amadeus 的永久总目标已经从“会陪伴的对话 AI”升级为“长期理解用户、能执行并验证现实任务的本地智能管家”。陪伴、人格和数字生命能力继续保留，但必须服务于真实问题解决与长期任务连续性。最高产品约束见 [PRODUCT_CHARTER.md](PRODUCT_CHARTER.md)。

## 0. 永久总目标

Amadeus 要提供“贾维斯感”：知道用户正在做什么，能把自然语言委托转成长期目标和可执行任务，调用本地或外部能力完成，读取真实结果，失败后恢复，并在有证据时才宣布完成；整个过程保持同一人格、同一记忆和同一事件事实源。

因此，旧设计中的“AI 伴侣”是人格与关系层，不再是产品终点。产品最终能力必须同时满足：**理解、行动、验证、持续、人格**。
