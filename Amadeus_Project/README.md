# Amadeus v6.0 - Kurisu AI Companion

> **产品总目标：** Amadeus 正在从对话型 AI 升级为具有长期理解、目标管理、真实执行、结果验证和主动跟进能力的本地智能管家。完整且永久的方向约束见 [PRODUCT_CHARTER.md](PRODUCT_CHARTER.md)。

本项目是一个本地运行的 AI 数字伴侣系统。v6.0 将启动能力、关系连续性、对话质量、摄像头能力和立绘表现收敛为一条可验证的体验闭环。
